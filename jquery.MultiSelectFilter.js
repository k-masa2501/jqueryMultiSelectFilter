    ...
    var methods = {
        ...
        __set_multiValule: function(obj) {
            ...
            if (tmp.length <= option.textlen) {
                if (tmp.length > 0) {span_text.text(tmp.join(','));}
            } else {
        ...
        _focusout: function(obj) {
            ...
            if (div_multi_ctl.attr('data-onmouse') != '1' && button.attr('data-onmouse') != '1') {
                methods._close(obj);
            }
        },
        ...
        _set_button_label: function(count, selection, obj) {
            ...
            if (count <= option.textlen) {
                ...
                if (checked_arry.length <= 0) {checked_arry.push(option.defalult);}
        ...
        __create_checkbox: function(selection, chkbox_id, index) {
            ...
            checked = selection[2] == 1 ? "checked='checked'" : "";
        ...
        _get_options: function(arg, obj) {
            ...
            if (arg != null && typeof arg === 'object') {
                ...
                if ('textlen' in arg && isFinite(arg.textlen) && arg.textlen > 0) {textlen = arg.textlen;}
